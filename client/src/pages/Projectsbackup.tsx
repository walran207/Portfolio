...
const projects: Project[] = [
  {
    ...
    gallery: [
      ...
      "/GradeKo/11.png?auto=format&fit=crop&w=1400&q=80",
      "/GradeKo/12.png?auto=format&fit=crop&w=1400&q=80",
      "/GradeKo/13.png?auto=format&fit=crop&w=1400&q=80",
      "/GradeKo/14.png?auto=format&fit=crop&w=1400&q=80",
      "/GradeKo/15.png?auto=format&fit=crop&w=1400&q=80",
      "/GradeKo/16.png?auto=format&fit=crop&w=1400&q=80",
      "/GradeKo/17.png?auto=format&fit=crop&w=1400&q=80",
      "/GradeKo/18.png?auto=format&fit=crop&w=1400&q=80", 
      "/GradeKo/19.png?auto=format&fit=crop&w=1400&q=80",
  ...
  },
  {
    ...
    gallery: [
      "https://images.unsplash.com/photo-1508387028630-0f45ae2170ff?auto=format&fit=crop&w=1400&q=80",
      "https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&fit=crop&w=1400&q=80",
      "https://images.unsplash.com/photo-1454165205744-3b78555e5572?auto=format&fit=crop&w=1400&q=80",
    ],
              ...
              {slides.map((image, idx) => (
                <CarouselItem key={image} className="h-full">
                  <button
                    ...
                    className="group relative h-full w-full overflow-hidden rounded-2xl bg-gradient-to-br from-[#2f1a3a] to-[#120713] p-4 flex items-center justify-center cursor-zoom-in shadow-2xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
                    aria-label={`Zoom ${project.title} screen ${idx + 1}`}
                  >
                    <img
                      src={image}
                      alt={`${project.title} screen ${idx + 1}`}
                      className="max-h-full w-full rounded-2xl object-contain transition-transform duration-300 group-hover:scale-[1.02]"
                      loading="lazy"
                    />
                  </button>
                </CarouselItem>
        ...
        <Carousel setApi={setCarouselApi} opts={{ loop: true }}>
          <CarouselContent className="h-full">
            {data.images.map((image) => (
              <CarouselItem key={image} className="h-full">
                <div className="flex h-full items-center justify-center rounded-2xl bg-black/80 p-2">
                  <img
                    src={image}
